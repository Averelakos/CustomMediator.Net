...
/// </summary>
public readonly struct VoidType : IEquatable<VoidType>, IComparable<VoidType>, IComparable
{
    private static readonly VoidType _value = new();

    /// <summary>
    /// Default and only value of the <see cref="VoidType"/> type.
    /// </summary>
    public static ref readonly VoidType Value => ref _value;

    /// <summary>
    /// Task from a <see cref="VoidType"/> type.
    /// </summary>
    public static Task<VoidType> Task { get; } = System.Threading.Tasks.Task.FromResult(_value);
    ...
    /// </returns>
    public int CompareTo(VoidType other) => 0;
    ...
    public static bool operator ==(VoidType first, VoidType second) => true;
    ...
    public static bool operator !=(VoidType first, VoidType second) => false;
